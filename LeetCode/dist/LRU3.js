 ...
 * cache.get(4);       // 返回  4
 */
var LRU3Cache = /** @class */ (function () {
    function LRU3Cache(capacity) {
        this.map = new Map();
        this.capacity = 10;
     ...
     *  2.2 返回value
     */
    LRU3Cache.prototype.get = function (key) {
        ...
        console.log("get(".concat(key, "); result:"), this.map, 'value:', value);
        return value;
    };
    /**
     *
     ...
     *
     */
    LRU3Cache.prototype.put = function (key, value) {
        // 1. 不管存不存在，直接删除
        this.map.delete(key);
        // 2. 将最新的值放在最后
        this.map.set(key, value);
